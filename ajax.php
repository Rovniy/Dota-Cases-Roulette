...
$config = array( 'hostname' => 'localhost', 'username' => 'root', 'password' => '', 'dbname' => 'dota2_bd' );
...
function Load()
{
	...
	if( mysql_num_rows($query) > 0 )
	{
		...
		foreach ( $messages as $value )
		{
			...
			$js .= 'chat.append("<span><strong>[' . $value['name'] . ']</strong>: ' . $value['text'] . '</span>");'; // добавить сообщние (<span>Имя &raquo; текст сообщения</span>) в наш div 
		}
