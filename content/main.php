<div class="row wrapper ">
	<h1 class="Dota2"><small>ИСПЫТАЙ СВОЮ УДАЧУ</small><br/>ДО СЛЕДУЮЩЕГО РОЗЫГРЫША ОСТАЛОСЬ</h1>
</div>
<div class="row wrapper">
	<div class="counter">
		<div class="cifri">00:<span id="time">05:01</span></div>
    </div>
</div>			
...
<div class="row roz-items">
	...
	<div class="roz-item item6 grade-legendary" id="obj6">
		...
		<div class="Opisanie">
			<span>Warrior's Retribution Set<br/><strong>(80 руб.)</strong></span>
		</div>
	</div>				
	<div class="roz-item item7 grade-arcane" id="obj7">
		<img src="http://steamcommunity-a.akamaihd.net/economy/image/W_I_5GLm4wPcv9jJQ7z7tz_l_0sEIYUhRfbF4arNQkgGQGKd3kMuVpMgCwRZrguPdUmZ0v8CaOrdEQY2Dtf9T0OuPKKZiByjXYcffIBhbz9AiYrhj08QBiHWUOJGCtApupPHgQzvXArCfjBsydgfwq2ZwlCw3CM"/>
		<div class="Opisanie">
			<span>Totem of Deep Magma<br/><strong>(477 руб.)</strong></span>
		</div>
	</div>				
	<div class="roz-item item8 grade-arcane" id="obj8">
	...
	<div class="roz-item item9 grade-rare" id="obj9">
		<img src="http://steamcommunity-a.akamaihd.net/economy/image/W_I_5GLm4wPcv9jJQ7z7tz_l_0sEIYUhRfbF4arNQkgGQGKd3kMuVpMgCwRZrgqYZUDfxPtEbPflAQI4DafqVFe8C6yfy1ruTsJUe-t2LmYfyLa72hhVSiLQB-BCDIYrv5LF0Vy9WVDCKGZuwtlXivPIhZKBCqeBqkexcApxhuV3TcJEg4BiXd0"/>
		<div class="Opisanie">
			<span>Genuine Crystal<br/><strong>(845 руб.)</strong></span>
		</div>
	</div>				
	<div class="roz-item item10 grade-immortal" id="obj10">
